variable "location" {
  description = "Região do Azure onde os recursos serão provisionados (mesma região da VM do lab: eastus2)"
  type        = string
  default     = "eastus2"
}
...
variable "vm_size" {
  description = "Tamanho da VM (mesmo tamanho da VM do lab criada no portal)"
  type        = string
